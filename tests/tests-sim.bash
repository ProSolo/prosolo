...
bcftools mpileup -f ref.fa -T pos.tsv --no-BAQ -A -Q 0 --annotate AD bulk.bam single-cell.bam | bcftools view -e 'ALT=="<*>"' | bcftools norm -m -any | bcftools view -e 'ALT=="<*>"' -O b -o candidates.multiallelic.bcf
bcftools index candidates.multiallelic.bcf
bcftools mpileup -f ref.fa -T pos.tsv --no-BAQ -A -Q 0 --annotate AD bulk.bam single-cell.bam | bcftools view -i 'ALT=="<*>"' -O b -o candidates.no-alt.bcf
bcftools index candidates.no-alt.bcf
bcftools concat --allow-overlaps -O b -o candidates.bcf candidates.multiallelic.bcf candidates.no-alt.bcf
rm candidates.multiallelic.bcf candidates.multiallelic.bcf.csi candidates.no-alt.bcf candidates.no-alt.bcf.csi
